...
import 'package:maintenex/Features/authentication/controllers/signup/verify_email_controller.dart';
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              //Image
              Image(image: const AssetImage(TImage.deliveredEmailIllustration), width: THelperFunctions.screenWidth()*0.6,),
              ...
              const SizedBox(height: TSizes.spaceBtwItems),
              SizedBox(width: double.infinity, child: ElevatedButton(onPressed: () => controller.sendEmailVerification(), child: const Text(TText.resendEmail))),
            ]
          )
        )
      )
